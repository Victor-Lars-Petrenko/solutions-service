    ...
    <section className='choose__container'>
        <section className='choose__left-side'>
            <article className='choose__left-side-container'>
                ...
                <h1 className='section__big-title'>Choose <span className='section__underline-title'>Working</span>
                <span className='section__big-title section__big-title--highlight '>With Us</span></h1>
                </section>
        ...
        <article className='choose__right-side-container'>
                ...
                <p className='section__paragraph'>Lorem ipsum dolor sit amet consectetur adipisicing </p>
                <p className='section__paragraph'>elit. Neque repellendus minima reiciendis nobis  </p>

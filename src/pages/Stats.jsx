...
export default function Stats() {
  return (
    ...
    <article className='stats__article stats__article--green'>
      ...
      <p className='section__paragraph article__subtitle'>Finished Projects</p>
     </article>
    ...
    <img src="/img/happy.png" alt="happy" className='article__image'/>
      ...
      <p className='section__paragraph article__subtitle'>Happy customers</p>
    </article>
    ...
    <img src="/img/years.png" alt="year" className='article__image'/>
      ...
      <p className='section__paragraph article__subtitle'>Years of experience</p>
    </article>

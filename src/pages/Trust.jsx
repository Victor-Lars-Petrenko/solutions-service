  ...
  return (
    <section className='trust__container'>
        <article className='trust__info'>
            <h1 className='section__big-title'>Trusted By Over <span className='section__underline-title'>500</span> Clients Around The World</h1>
        </article>
        <article className='trust__cards'>
            <ul className='trust__cards-list'>
                <li className='trust__list-item'><span className='list-item__text'>Logo</span></li>
                <li className='trust__list-item'><span className='list-item__text'>Logo</span></li>
                <li className='trust__list-item'><span className='list-item__text'>Logo</span></li>
                <li className='trust__list-item'><span className='list-item__text'>Logo</span></li>
                <li className='trust__list-item'><span className='list-item__text'>Logo</span></li>
